...
## Modified date : 2019-08-15 11:42
## Author : DARREN
## Describe : not set
...
#pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade elasticsearch==6.4.0
pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade elasticsearch
